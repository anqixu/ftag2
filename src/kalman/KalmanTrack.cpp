...
double KalmanTrack::process_noise_pos = 0.5;
double KalmanTrack::process_noise_vel = 0.5;
double KalmanTrack::process_noise_rot = 0.1;
double KalmanTrack::observation_noise_pos = 0.1;
double KalmanTrack::observation_noise_rot = 0.05;
unsigned int KalmanTrack::number_of_state_dimensions = 10;
unsigned int KalmanTrack::number_of_observation_dimensions = 7;
unsigned int KalmanTrack::number_of_process_noise_dimensions = 10;
unsigned int KalmanTrack::number_of_observation_noise_dimensions = 7;
